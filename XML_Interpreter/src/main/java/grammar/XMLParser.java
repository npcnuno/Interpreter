// Generated from /home/katchow/Projects/ISCTE/3ano/compiladores/semana3/XML_Interpreter/src/main/kotlin/grammar/XMLParser.g4 by ANTLR 4.13.2
package grammar;
...
public class XMLParser extends Parser {
	...
	public final DocumentContext document() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 290L) != 0)) {
				{
				{
				setState(19);
				misc();
